...
function Namewise() {
  ...
  const noofuser1 = ticketData.tickets.filter((ticket) => ticket.userId === 'usr-1').length;
  const noofuser2 = ticketData.tickets.filter((ticket) => ticket.userId === 'usr-2').length;
  const noofuser3 = ticketData.tickets.filter((ticket) => ticket.userId === 'usr-3').length;
  const noofuser4 = ticketData.tickets.filter((ticket) => ticket.userId === 'usr-4').length;
  const noofuser5 = ticketData.tickets.filter((ticket) => ticket.userId === 'usr-5').length;
  ...
  return (
        ...
        <div id="backlog" className="colgrid">
          <div className='topofcolGrid'>
            <img src='usr-1.jpg' alt='not found'></img>
            <h4>Anoop Sharma  <span>{noofuser1}</span></h4>
          </div>
          <div className='downofcolGrid'>
            {ticketData.tickets
            .filter((ticket) => ticket.userId === 'usr-1')
            .map((ticket) => (
                <NormalCard key={ticket.id} ticket={ticket} />
            ))}
          </div>
        </div>
        ...
        <div id="todo" className="colgrid">
          <div className='topofcolGrid'>
              <img src='usr-2.jpg' alt='not found'></img>
              <h4>Yogesh  <span>{noofuser2}</span></h4>
            </div>
            <div className='downofcolGrid'>
              {ticketData.tickets
        ...
        <div id="inprogress" className="colgrid">
          <div className='topofcolGrid'>
              <img src='usr-3.jpg' alt='not found'></img>
              <h4>Shankar Kumar  <span>{noofuser3}</span></h4>
            </div>
            <div className='downofcolGrid'>
              {ticketData.tickets
        ...
        <div id="done" className="colgrid">
          <div className='topofcolGrid'>
              <img src='usr-4.jpg' alt='not found'></img>
              <h4>Ramesh  <span>{noofuser4}</span></h4>
            </div>
            <div className='downofcolGrid'>
              {ticketData.tickets
        ...
        <div id="cancel" className="colgrid">
          <div className='topofcolGrid'>
              <img src='usr-5.jpg' alt='not found'></img>
              <h4>Suresh  <span>{noofuser5}</span></h4>
            </div>
            <div className='downofcolGrid'>
              {ticketData.tickets
