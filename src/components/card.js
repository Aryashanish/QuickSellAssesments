...
import { faWifiStrong, faLayerGroup, faSignal,faWindowMinimize,faSpinner, faBarsProgress, faBan, faCheckCircle , faExclamation , faCircle} from '@fortawesome/free-solid-svg-icons';
  ...
  let priorityIcone;
    ...
    switch(ticket.status) {
        ...
        case 'Backlog':
            ...
            break;
        default:
            statusIcon = faExclamation; // Default icon if status is unknown
  }
